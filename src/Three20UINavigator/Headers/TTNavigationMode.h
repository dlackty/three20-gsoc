...
typedef enum {
  ...
  TTNavigationModePageSheet,         // a new view controller is created and presented as page sheet
  TTNavigationModeFormSheet,         // a new view controller is created and presented as form sheet
